...
export function absoluteRedirect(path, url) {
...
export function serveRelativeRedirects(path, url) {
...
export function serveMultipleRedirects(path) {
    const n = parseInt(path.split('/')[2]);
...
export function serveRedirectTo(params) {
