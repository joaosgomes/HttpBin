...
export function serveJSON(): Response {
  const data = {
...
export function serveJSONValue(path: string): Response {
...
export function serveXML(): Response {
...
export function serveXMLValue(path: string): Response {
...
export function generateRandomBytes(path: string, url: URL): Response {
...
export function serveRange(path: string, request: Request): Response {
...
export function serveStatus(path: string): Response {
...
export function serveStatusNoResponse(path: string): Response {
  const code = parseInt(path.split('/')[2]);
...
export function serveResponseHeaders(params: URLSearchParams): Response {
...
export function serveWs(request: Request): Response {
